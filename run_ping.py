...
#def updatePing(rttRsts, hostname, node_id):
#	update_ping_url = "http://146.148.66.148:8000/ping/add/"
#	rttRsts['name'] = hostname
#	rttRsts['id'] = node_id
#	ping_info = urllib.urlencode(rttRsts)
#	urllib.urlopen(update_ping_url, ping_info)

def pingAllSrvs(hostname, srvs):
	pingRsts = {}
	for key in srvs:
		cur_rtt = getMnRTT(key, srvs[key], 5, 5)
	...
	# updatePing(pingRsts, hostname)

srvs = {
	'az01' : 'cache01.cloudapp.net',
	'az02' : 'cache02.cloudapp.net',
	'az03' : 'cache03.cloudapp.net',
	'az04' : 'cache04.cloudapp.net',
	'az05' : 'cache05.cloudapp.net',
	'az06' : 'cache06.cloudapp.net',
	'az07' : 'cache07.cloudapp.net',
	'az08' : 'cache08.cloudapp.net',
	'az09' : 'cache09.cloudapp.net',
	'az10' : 'cache10.cloudapp.net',
